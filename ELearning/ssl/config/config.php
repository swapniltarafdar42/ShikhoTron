...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost/shikhotron/ELearning'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'bdu662938b1961c6'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'bdu662938b1961c6@ssl'); // your store password.
}
