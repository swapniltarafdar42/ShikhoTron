...
class OrderTransaction {
    ...
    public function saveTransactionQuery($post_data)
    {
        ...
        $sql = "INSERT INTO orders (name, email, phone, amount, address, status, transaction_id,currency,course_id)
                                    VALUES ('$name', '$email', '$phone','$transaction_amount','$address','Pending', '$transaction_id','$currency','$course_id')";
